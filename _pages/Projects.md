...
feature_row_Club:
  - image_path: /assets/images/IMG_1462.jpeg
    ...
    btn_class: "btn--primary"
---
{% include feature_row id="feature_row_drone_seagrass" type="left" %}

{% include feature_row id="feature_row_drone_wildfire" type="right" %}
